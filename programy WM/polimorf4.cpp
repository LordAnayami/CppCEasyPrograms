// Hierarchia klas z destruktorem wirtualnym
...
{
   public:
      //------------ JEDYNA MODYFIKACJA W STOSUNKU DO polimorf3.cpp -------------
      virtual ~instrument() { cout << "destruktor instrumentu" << endl; }
      // wirtualny destruktor gwarantuje wywolanie destruktorow z klas pochodnych
      //-------------------------------------------------------------------------
...
int main()
{
   ...
   for(int i = 0; i < 5; i++)
      delete orkiestra[i]; // tutaj uruchamiane sa wirtualne destruktory
